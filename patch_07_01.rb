...
tests_file_ref = add_file_to_group(project, 'LevainTests', 'KnowledgeLoaderTests.swift')

unless tests_target.source_build_phase.files_references.include?(tests_file_ref)
  tests_target.source_build_phase.add_file_reference(tests_file_ref, true)
end
